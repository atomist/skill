...
export async function writeSkillYaml(cwd: string, skill: AtomistSkillInput): Promise<void> {
...
export async function generateSkill(cwd: string, validate: boolean): Promise<void> {
    let s;
